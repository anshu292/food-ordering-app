      ...
      <div className="flex flex-col justify-between pb-4 border-b md:flex-row gap-3">
        <div className="flex flex-col text-xs text-[#535665] font-medium gap-1">
          ...
          <span className="">
            ...
            <i className="text-orange-600 fa-solid fa-location-dot"></i>
          </span>
          <span className="">
        ...
        <img
          ...
          src={IMG_CDN_URL + resMenu?.cards[0]?.card?.card?.info?.cloudinaryImageId}
          alt=""
        />
      </div>
            ...
            return (
              ...
              >
                ...
                <div className=" flex flex-col gap-1 relative md:w-1/4 w-auto">
                  ...
                  />
                  <button
                    className="absolute bottom-[-8px] bg-white shadow-md border self-center text-[10px] py-1 px-4 font-medium rounded  active:scale-90 hover:bg-yellow-300 transition-all duration-300 ease-in-out"
