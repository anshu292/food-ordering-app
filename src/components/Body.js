...
import { filterData, filterdata } from "../utils/helper";
...
const Body = ({user}) => {
  ...
  const [searchText, setSearchText] = useState("");
    ...
    async function getData() {
        ...
        "https://www.swiggy.com/dapi/restaurants/list/v5?lat=28.6295538&lng=77.0801899&page_type=DESKTOP_WEB_LISTING"
      );
